$(function () {
  ...
  wind.on("scroll", function () {
    ...
    if (bodyScroll > 300) {
      ...
      logo.attr("src", "img/logo-kowaris-dark.png");
    } else {
      navbar.removeClass("nav-scroll");
      logo.attr("src", "img/logo-kowaris.png");
    }
  });
...
/* ===============================  Count established years  =============================== */

function yearEstablied() {
  $(document).ready(function () {
    var currentYear = new Date().getFullYear();
    var startYear = 2021;
    var yearDiff = currentYear - startYear;

    var resultElement = $("#yearestablished");
    resultElement.text(yearDiff);
  });
}
